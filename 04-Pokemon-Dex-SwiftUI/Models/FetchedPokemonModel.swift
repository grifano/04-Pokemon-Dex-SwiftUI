//
//  FetchedPokemonModel.swift
//  04-Pokemon-Dex-SwiftUI
//
//  Created by sorlenko on 05/08/2026.
//

import Foundation

struct FetchedPokemonModel: Decodable {
    let id: Int16
    let name: String
    let types: [String]
    let hp: Int16
    ...
    init(from decoder: any Decoder) throws {
        ...
        while !typesContainer.isAtEnd {
            ...
            let typeDictionaryContainer = try typesDictionaryContainer.nestedContainer(keyedBy: CodingKeys.TypeDictionaryKeys.TypeKeys.self, forKey: .type)
            let type = try typeDictionaryContainer.decode(String.self, forKey: .name)
        ...
        while !statsContainer.isAtEnd {
            ...
            let baseStat = try statDictionaryContainer.decode(Int16.self, forKey: .baseStat)
